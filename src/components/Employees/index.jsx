...
import { Layout, Content, Option, Title, Cont, BtnContent, Button } from "./style";
        ...
        <Layout>
            ...
            <Option>
                <Content>
                    ...
                    <BtnContent>
                        <Link to="/employees/register"><Button>Cadastrar</Button></Link>
                    </BtnContent>
                    <Cont>
                        <SearchBar 
                    ...
                    {modal? <ModalDelete modal={handleModal} yes={DeleteEmployees}/>: <></>}
